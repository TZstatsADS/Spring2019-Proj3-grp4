...
Get_Neighbor_and_Label <- function(Index, LR_Data, HR_Data, Samples){
  ...
  LR_bottom_left <- get_pixel(LR_Data, Row+1, Col_Index-1)
  LR_up <- get_pixel(LR_Data, Row_Index-1, Col_Index)
  LR_center <- get_pixel(LR_Data, Row_Index, Col_Index)
  LR_bottom <- get_pixel(LR_Data, Row_Index+1, Col_Index)
  LR_up_right <- get_pixel(LR_Data, Row_Index-1, Col_Index+1)
  LR_right <- get_pixel(LR_Data, Row_Index, Col_Index+1)
  LR_bottom_right <- get_pixel(LR_Data, Row_Index+1, Col_Index+1)
