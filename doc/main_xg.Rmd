...
```{r wkdir, eval=FALSE}
set.seed(2018)
setwd("C:/Users/86155/Desktop/Fall2018-Proj3-Sec2-grp5-master")
...
```{r loadlib}
source("C:/Users/86155/Desktop/Fall2018-Proj3-Sec2-grp5-master/lib/XGB/train_xgboost.R")
source("C:/Users/86155/Desktop/Fall2018-Proj3-Sec2-grp5-master/lib/XGB/test_xgboost.R")
```
...
source("C:/Users/86155/Desktop/Fall2018-Proj3-Sec2-grp5-master/lib/XGB/cross_validation_xgboost.R")
...
if(run.cv){
  ...
  save(err_cv_xgboost, file="C:/Users/86155/Documents/GitHub/Spring2019-Proj3-spring2019-proj3-grp4/output/err_cv_xgboost.RData")
}
```
...
```{r cv_vis}
if(run.cv){
  load("C:/Users/86155/Desktop/Fall2018-Proj3-Sec2-grp5-master/output/XGB_3_3/err_cv_xgboost.RData")
  plot(model_values, err_cv_xgboost[,1], xlab="Interaction Depth", ylab="CV Error", main="Cross Validation Error", type="n", ylim=c(0, 0.05))
  points(model_values, err_cv_xgboost[,1], col="blue", pch=16)
  lines(model_values, err_cv_xgboost[,1], col="blue")
  arrows(model_values, err_cv_xgboost[,1]-err_cv_xgboost[,2], model_values, err_cv_xgboost[,1]+err_cv_xgboost[,2], length=0.1, angle=90, code=3)
}
```
...
save(fit_train_xgboost_3_3, file="C:/Users/86155/Documents/GitHub/Spring2019-Proj3-spring2019-proj3-grp4/output/fit_train_xgboost.RData")
```
...
```{r superresolution}
source('C:/Users/86155/Desktop/Fall2018-Proj3-Sec2-grp5-master/lib/XGB/superResolution_xgboost.R')
